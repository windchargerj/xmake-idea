...
target("myproject")
    ...
    add_defines("VERSION=1.0", "ENABLE_FEATURE_A", "ENABLE_FEATURE_B")
    add_links("pthread", "dl", "m")

local very_long_table = {
    first_element = "value1",
    second_element = "value2",
    third_element = "value3"
}

function process(arg1, arg2, arg3, arg4)
