...
import io.xmake.lang.syntax.parser.XMakeLuaParserAdaptor
...
class XMakeLuaParserDefinition : ParserDefinition {
    ...
    override fun createElement(node: ASTNode): PsiElement {
        ...
        return when (elType.ruleIndex) {
            ...
            LuaParser.RULE_var -> LuaVariableDefinition(node)
            LuaParser.RULE_functiondef -> LuaFunctionDefinition(node)
