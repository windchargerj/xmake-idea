...
internal fun Project.xmakeBuildProfile(target: ExecutionTarget): XMakeBuildProfile? {
...
internal fun Project.xmakeBuildProfileOrThrow(target: ExecutionTarget): XMakeBuildProfile =
    xmakeBuildProfile(target)
...
internal val Project.activeXMakeBuildProfile: XMakeBuildProfile?
    get() = xmakeBuildProfile(ExecutionTargetManager.getActiveTarget(this))
        ?: xmakeBuildProfiles.getProfiles().singleOrNull()
