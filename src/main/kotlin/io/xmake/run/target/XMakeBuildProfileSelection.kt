...
internal fun Project.requireXMakeBuildProfile(target: ExecutionTarget): XMakeBuildProfile =
...
internal fun Project.activeXMakeBuildProfile(): XMakeBuildProfile? =
    xmakeBuildProfile(ExecutionTargetManager.getActiveTarget(this))
